...
\begin{center}
	...
	New release & Deployment time & Downtime \\ \hline
...
\begin{center}
	...
	CDM & Measurable metrics are only performance \\ \hline
	Dialog & \\
    \hline
    \end{tabular}
\end{center}
...
%Nykyään pyritään siihen että kaikki mitä tehdään on asiakkaalle varten tehtyjä. Omaa tuotekehitystä ei voida oikein laskuttaa keneltäkään. Tarkoitus on tehdä featureita vaan jos asiakas on niitä pyytänyt. Jos uusi projekti alkaa, kehitetään sille uusia vaatimuksia. Usein niitä kuitenkin tulee pitkin projektia sillä asiakkaan mieli muuttuu. Uusia featureita ja muutoksia jo tehtyihin featureihin. Devaajalla ei aivan selvää mistä uudet featuret tulevat. Haluttaisiin enemmän näkyvyyttä siihen mistä vaatimukset tulevat, ja mitä tarkoitusta varten jotkut featuret tehtävät. Tästä ollut puhetta.	Lähinnä asiakkaiden vaatimuksia, on kuitenkin osittain ollut omaa tuotekehitystä, esim. elasticsearch. 	suurin osa yritetään tehdä asiakaslähtöisesti, ja pitäisikin tehdä. vaikka olisi miten hyvä tuotteen omistaja tai asiakasvastaava, harvoin kukaan voi tietää mitä asiakas haluaa ilman että siltä on kysytty jotain. Tällä hetkellä ei tehdä käytännössä ollenkaan sisäistä tuotekehtiystä, ja kaikki kehitys on asiakaslähtöistä.	For the last two projects they came from the product owner and directly from the customer. Maybe sometimes PO would help the customers to discuss what they need. Sometimes we want to improve the codebase and implement the tasks ourselves to do that.	business-omistajilta pitäisi tulla, ja heidän pitäisi keskustella näistä asiakkaiden kanssa. varmaan sieltä suunnalta, vähän kummastakin. talon sisältä ja talon ulkopuolelta. jos on räätälöity projekti, on se aika pitkälti asiakkaan toiveiden varassa. myös custom projektit näin. suurin osa on ollut custom-projekteja, ja vasta viime vuosina alkanut tuotteistaminen.	viime vuosien aikana menty asiakasprojektien ehdoilla. pidetty tuotekehtiyksen ohjausryhmää, jossa halutaan nähdä eteenpäin miten tuote kehittyy. ei ole ollut resursseja tähän asiakasprojektin tiimoilta. asiakasprojekteihin myyty keskeneräisä tuotteita, joita jouduttu asiakasprojekteissa viimeistelemään. tämä on luonut painetta ja resurssitarvetta. on miettitty miten tuotetta voidaan kehittää, muttei siihen ole ollut resursseja.		Tällä hetkellä tulee suoraan asiakastarpeista. Jonkin verran on myös sellaisia joita tiedetään ettei tämä toimi hyvin ja sitä pyritään parantamaan, nämäkin usein asiakas huomannut. 	Tällä hetkellä lähes ainoastaan asiakkaiden tarpeen tehtyjä featureita. Asiakkaille saatetaan luvata feature joka halutaan. Aluksi oli jotain omia visioita. Ei tietoa miten asiakas ja PO keskutelevat. 	Devaajat tekevät parannusehdotuksia, myös product ownerit keksivät featureideoita. Uskovat, että asiakas haluaa tämän. Mahdollisesti myös poistettavia ideoita. Ei tietoa asiakkaan ja johtoportaan välisestä kommunikaatiosta - yritetään saada asiakkaalta sitoumus siihen, mitä tehdään. 	Vaatimuksia asiakkailta, tulee kuitenkin myös oman tiimin sisältä. Istumme usein viikottain alas, mietimme ja voi tulla omia kehitysideoita joita tiedämme että asiakkaat tulevat hyödyntämään. Asiakkailla on kuitenkin paljon omia juttuja joita he tarvitsevat. Nämä ovat kuitenkin sellaisia, joita muutkin asiakkaat voivat hyödyntää. Dialogissa pyritään siihen, että on vain yksi Dialog-versio kaikilla asiakkailla. Nyt on kuitenkin muutamilla asiakkailla vähän eri termistöä ja juttuja. Jotkut asiakkaat käyttävät Dialogista force-integraatio, jotkut käyttävät perusdialogia joissa on esim siebel-integraatio. Helsingin energialla on taas eri crm. 	Tavoite olisi 50/50. Puolet olisi meidän näkemystä millä voidaan tehdä bisnestä, loput asiakkailta. Nyt kuitenkin 100/0, ja yli vuoden aikana kaikki on tullut asiakkaiden tarpeista Dialogiin. Heikon palvelukuvauksen takia on tullu kiire tehdä asioita. Aikatauluja tekemiseen ei päästä itse sovittamaan niin hyvin. Meillä on kuitenkin roadmappi, joka ei ole edennyt meidän johtamana vaan asiakasprojektien johtamana. Jos ajatellaan experimenttejä ja muita, pitäisi palautteen kerääminen saada tulemaan asiakkailta.  Dialogin osalta tarvitaan sellaisia käyttäjiä jotka haluavat auttaa meitä, ja heillä on motivaatiota auttaa meitä koska he hyötyvät siitä itse.
