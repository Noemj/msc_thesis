...
If the experiments are publicized, it can bias the users and affect or even spoil the experiments outcome.  
...
%TODO: jatka tästä
In Dialog, the need for data-driven decisions is greater than that of CDM due to the visible parts of the software. Even though Dialog doesn't generate profit per-se, optimizing the time it takes for customers to perform certain tasks increases the benefit of Dialog for the customers. The interviewees have some ideas on the essential metrics. These are time spent on performing certain tasks, amount of errors encountered in certain features and amount of back-selections indicating mistakes made by the user. 
...
-Building modular products is hard, and can be made easier with total automation
