...
TODO: finalize
The teams under study have been working with agile and lean practices during the last couple of years, 
...
\end{aquote}
However, the interviewees are positive that the customers are willing to allow the data collection, since the product has also been bought and the purpose of data collection is to develop the software in a way that adds value for the customer. 
\begin{aquote}{Dialog product owner}
