...
\begin{center}
    ...
    Connection & Transferring the software product to a customer-owned environment  \\ 
...
\begin{center}
	...
	New release & Ongoing critical tasks by users cannot be interrupted with downtime \\
    \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \hline
    \textbf{Problem area} & \textbf{Specific problem} \\ \hline
    Funding & Requirements by customers bring in revenue, and are prioritized over own product development \\ \hline
    Team composition & \\ \hline
...
\begin{center}
	...
	Data collection & Proper legal agreements need to be made \\ 
    \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    General & Measurable metrics for the software products are not extensively conceived \\ \hline
