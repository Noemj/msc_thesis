...
A major problem found in the interviews was that currently the reliability in new versions is low. The manual build process involves human error factor, which can cause multiple bugs in new versions.  
