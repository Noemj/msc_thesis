...
\begin{table}[!h]
    ...
    Challenges of applying the practices in the B2B domain & RQ 1: What are the B2B specific challenges of continuous delivery and continuous experimentation? & Template analysis of the interview results & 12 interviews, documentations of the development process and products, literature \\ \hline
...
\subsubsection{A/B testing challenges}
Challenges in A/B testing are analyzed based on the product description documents and two sections of the interviews: feedback collection and experimentation.
