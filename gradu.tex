...
CDM is seen as a hard target for experiments due to the hard-coded interfaces and the nature of the application. The fact that there are no human users removes the possibilities of front-end A/B testing, the most typical experiment. 
