...
\noindent When the benefits and requirements are identified and the process is approved by a company, it has to be adopted in practice. This requires an answer to questions what, how, who and when. This question is answered by applying Fagerholm et al. model \cite{fagerholm2014building} to the case company.  \newline
...
This section summarises key findings of the case study. It is structured according to the research questions, allowing the progress from a higher-level perspective to more detailed views. 

%\subsection{Perceived problems}
%What kind of problems were found?

\subsection{Differences in continuous delivery and continuous experimentation in B2B as compared to B2C}
