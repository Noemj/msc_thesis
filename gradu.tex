...
\noindent \textbf{RQ 3: Why does continuous experimentation benefit the case company?} %What are the problems and strengths of the current development process?
...
\section{Literature: Continuous Delivery and Continuous Experimentation}
%Agile
...
\begin{center}
    ...
    \hline
    ID & Question \\ \hline
    a & What is the current deployment process like? \\ \hline
    a & How is it decided when to deploy? \\ \hline
    a & How is it decided what to deploy? \\ \hline
    a & How often is new version released? \\ \hline
    a & How often are the new versions deployed to customer? \\ \hline
    a & How are the deployment dates chosen? \\ \hline
    a & Which parts of the deployment process are manual? \\ \hline
    a & Which parts of the deployment process are hard to measure automatically? \\ \hline
    a & Is the customer involved in the deployment process? \\ \hline
    a & Does the customer have to do something when a version is deployed? \\ \hline
    a & What are the strenghts in the current deployment process? \\ \hline
    a & What are the problems in the current deployment process? \\ \hline
    \hline
    \end{tabular}
\end{center}
...
%\centerline{
    ...
    \hline
    ID & Question \\ \hline
    a & Describe the customer interaction process. \\ \hline
    a & From your point of view, what are the challenges with the customer interaction? \\ \hline
    a & From your point of view, what are the strengths with the customer interaction? \\ \hline
    a & From your point of view, how could the interaction with the customer be improved? \\ \hline
	a & Is it common for customers requirements to change? \\ \hline
    a & Is the development team aware of the customers present requirements? \\ \hline
	a & How is feedback collected from the customer? \\ \hline
	a & What are the B2B specific challenges in feedback collection? \\ \hline
	a & From your point of view, how could the feedback collection be improved? \\ \hline
	a & How is the customer feedback used?  \\ \hline
	a & From your point of view, how could the feedback usage be improved? \\ \hline
...
\begin{center}
    ...
    \hline
    ID & Question \\ \hline
    a & How many end-users does the product have? \\ \hline
    a & How is usage data collected? \\ \hline
    a & How could usage data collection be improved? \\ \hline
    a & What challenges would real-time deployment have? \\ \hline
    a & What challenges would plugged-in data collection instruments have? \\ \hline
    a & If data were to be collected in customer environment, what challenges would be faced storing it? \\ \hline
    \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \hline
    ID & Question  \\ \hline
	a & What are the strenghts in the current development process? \\ \hline
    a & What are the problems in the current development process? \\ \hline
    \hlineo
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \hline
    ID & Question \\ \hline
    a & Could your product be instrumented with a data collection service? If not, why? \\ \hline
    a & In your product, could experiments be quickly deployed to the customer environment? \\ \hline
    a & In your product, could the development process be guided by A/B testing? \\ \hline
    a & Does your team have a data analyst? \\ \hline
    \hline
    \end{tabular}
\end{center}
