...
An interesting research question for further research is how the core findings of the thesis can be transferred to other companies working in the B2B domain with different software products. This includes investigating deviations found in the challenges and benefits stated in this thesis.

The findings provided by this thesis cannot be validated until the development models are adopted in practice.
...
For the continuous experimentation model discussed in research question 3, an interesting question is how to build the actual back-end infrastructure for experimentation.
