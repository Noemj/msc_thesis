...
\noindent \textbf{Why would continuous experimentation benefit the case company? What are the problems and strenghts of the current development process?}
...
\subsubsection{Components in continous experimentation}
...
\noindent When the benefits and requirements are identified and the process is approved by a company, it has to be adopted in practice. This question is answered by collectin ideas from the literature review and interview results. \newline
