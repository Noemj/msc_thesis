...
\begin{table}[htb]
    ...
    \hline
    \textbf{Specific problem} \\ \hline
    Customers are trained to use a certain UI, and modifications confuse the users \\ \hline
