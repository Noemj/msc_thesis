...
\begin{enumerate}
  ...
  \item Define an Overall Evaluation Criteria that can be collected and used to provide an answer to the hypothesis  
  \item Define the type of the experiment and the experimental problem 
  \item Implement the MVF or MVP. The experiment is chosen so that it can be run with trustworthy results. 
