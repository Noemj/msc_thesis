...
\begin{center}
	...
	The software has to be deployed to multiple customer environments \\ \hline
...
\begin{center}
	...
	Ongoing critical tasks by users cannot be interrupted with downtime \\ \hline
	Pilot customer is required for developing the process \\ \hline
...
\begin{center}
    ...
    Organizational divergency TODO: (different development culture within teams in company?) \\ 
    \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \hline
    \textbf{Specific problem} \\ \hline
    Low user volume limits the scopes of experiments \\ \hline
