...
\noindent \textbf{RQ 1: What are the differences of continuous delivery and continuous experimentation in B2B as compared to B2C?}
...
\begin{table}[htb]
    ...
    a & RQ 1: What are the differences of continuous delivery and continuous experimentation n B2B as compared to B2C? & Empirical case supported by conceptual analysis & 13 interviews, documentations of the development process, literature \\ \hline
...
\subsection{Continuous delivery: B2B vs B2C}
...
The continuous delivery practice will be compared in three aspects: technical, procedural and customer. 
...
\subsubsection{Procedural comparison}

\subsubsection{Customer comparison}
...
%pitää katsoa asiakkaan kanssa milloin heille käy versionpäivitys. 	Kun deployataan, palvelin täytyy pysäyttää ja laittaa varapalvelin pystyyn. 
    	...
    	%Changelogin teko per asiakas.

    	%Enemmänkin ohjelman luonne ja asiakkaan haluaminen olisi ongelma.
...
every customer doesnt like changing UI
...
customers need to understand the idea
...
\subsection{Continuous experimentation: B2B vs B2C}
...
Customer feedback is mainly received, not collected
Product owners in constant touch with the customers
E-mails
In our products (CDM), the feedback loop is short and feedback is received when something has been done. 
Retro after project
...
\subsection{TODO:rename Applying Fagerholm et al. model to the case company}
