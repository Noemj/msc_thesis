...
Continuous delivery provides an answer to many of the challenges faced in the current deployment process and product development in general, and the management considers improving the deployment process to be one of the most important improvements. %TODO: fix this
...
Since case studies only allow analytic, instead of statistical, generalisations cannot the findings be directly generalised to other cases. This limitation applies especially to the first two research questions, which mostly relied on the findings found from the interview. Limiting direct generalisation applies especially to applying continuous experimentation in practice, since software products and customers inevitably differ. 
