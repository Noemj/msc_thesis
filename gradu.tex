...
\begin{table}[htb]
    ...
    a & RQ 1: What is the Minimum Viable Process of continuous experimentation? & asd & Literature \\ \hline %How can the process be simplified without losing the benefits?
    a & RQ 2: What are the differences in continuous experimentation and continuous delivery in B2B as compared to B2C? & asd & 13 interviews, documentations of the development process, literature \\ \hline
    a & RQ 3: Why would continuous experimentation benefit the case company? What are the problems and strengths of the current development process? & asd & 13 interviews, documentations of the development process, literature \\ \hline
    a & RQ 4: How to collect usage data and customer feedback in B2B domain, where user amounts can be very low? & asd & 13 interviews, documentations of the development process, literature \\ \hline
    a & RQ 5: How should continuous experimentation be implemented as a development process in the B2B domain? & asd & 13 interviews, documentations of the development process, literature \\ \hline
    \end{tabular}
