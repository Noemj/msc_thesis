...
%Automate testing
Along with unit and integration tests, a critical step of the deployment process is the manual acceptance testing phase. The acceptance testing is performed in varying ways. For Dialog, some customers require to perform manual acceptance testing in an UAT environment before the deployment to production can be made. Other customers trust the developers to perform the acceptance testing, and the deployment to production can be negotiated without necessarily requiring it to pass the UAT phase. 
-Always deploy to UAT by the press of a button?
-How to inform the customers of this?
