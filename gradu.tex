...
\title{Extending the development process towards Continuous Delivery and Continuous Experimentation: A Case Study in the B2B Domain}
...
In the case company, selection of the development ideas is based almost exclusively on the opinions of leaders in the organization. Studies report similar results in other companies as well \cite{kohavi2007practical}. However, based on the earlier stated conclusions that large parts of what companies do is wrong, business value can be increased by moving towards data-based decision making. 
...
By constantly measuring the new features of the product, breaking the product can be avoided. Breaking the product essentially means 
...
The study investigated extending the development process towards continuous delivery and continuous experimentation to advance towards real-time value delivery. 

The results suggest that the challenges faced in continuous delivery in the B2B context are multidimensional, and related to the technical, procedural and customer aspects. The primary issues causing these challenges are the customer owned environment and the importance of the software product for the customer. However, the study also suggests that continuous delivery corresponds to many of the case company's primary needs, such as improving the reliability of versions and reducing the time required for deploying versions.

Challenges faced in continuous experimentation are also divided into four aspects: technical, organizational, customer and A/B testing. The challenges are mostly related to the lack of experimental mindset, technical properties of the software products and importance of the software product for the customer. The importance of the software product means that the customers depend on the application, and changes should be done carefully enough not to unnecessarily complicate the usage. 

Continuous experimentations benefit to the case company

The experimentation infrastructure and Build-Measure-Learn model \cite{fagerholm2014building} suits the case company well. As the Build-Measure-Learn model introduced is very general, certain steps required elaboration.  





Findings supported the research questions well. Many of the challenges in the current development process of the case company are in line with the benefits of continuous delivery and continuous experimentation. 



The findings indicate that extending the development process with continuous delivery and continuous experimentation is an expensive but benefical transition. While the technical challenges play a major role, the company needs to resolve issues in multiple other aspects ....
...
%%identify the theoretical and policy implications of the study with respect to the overall 
