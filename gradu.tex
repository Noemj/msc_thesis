...
The unit of analysis is the development process of the team. This includes the interaction with customers, and the tools used in the current development process. The unit of analysis is studied by focusing on interviewing individual members at different positions in the organisation. 
...
The primary source of information in this research are semi-structured interviews performed within the Development & Integration team and its management. The interview consists of pre-defined themes as follows: (1) current development process, (2) current interaction with customers, (3) problems and strengths in the current development process, (4) future ways with continuous deployment and continuous delivery. 
