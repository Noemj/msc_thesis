...
In the B2B context, certain additions to the initial model have to be made. One of such additions is the deployment to a UAT environment. As a result, the simplest experiment cycle for the case company is defined in the following steps. 
