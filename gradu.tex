...
The template is then used in interpretation to provide an account. 
-Listing codes
-Selectivity
-Openness
-Relationship between themes: Beyond the linear template

Presentation 
-set of individual cases
-an account structured around main themes identified
-thematic presentation of the findings, with different individual cases per theme
