...
\begin{table}[htb]
    ...
    a & RQ 2: What are the differences in continuous experimentation and continuous delivery in B2B as compared to B2C? & Empirical case supported by conceptual analysis & 13 interviews, documentations of the development process, literature \\ \hline
    a & RQ 3: Why would continuous experimentation benefit the case company? & Empirical case supported by conceptual analysis & 13 interviews, documentations of the development process, literature \\ \hline
    ...
    a & RQ 5: How should continuous experimentation be implemented as a development process in the B2B domain? & Empirical case supported by conceptual analysis & 13 interviews, documentations of the development process, literature \\ \hline
    \end{tabular}
