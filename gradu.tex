...
While the development is therefore mainly guided by customer needs that directly bring in revenue, the feature development is guided by the need to generalize the product for general customer needs. 

%product is developed towards a 

TODO: prosentuaalinen määrä asiaksfeatureita vs omia featureita tähä DIALOGille ja CDM:lle erikseen ois kova!!! 
